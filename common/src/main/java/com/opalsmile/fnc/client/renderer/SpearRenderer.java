...
public class SpearRenderer extends GeoEntityRenderer<Spear> {
    ...
    @Override
    public RenderType getRenderType(Spear animatable, ResourceLocation texture, @Nullable MultiBufferSource bufferSource,
                                    float partialTick) {
        return RenderType.entityCutout(texture);
    }

    @Override
    public void preRender(PoseStack poseStack, Spear animatable, BakedGeoModel model, MultiBufferSource bufferSource,
